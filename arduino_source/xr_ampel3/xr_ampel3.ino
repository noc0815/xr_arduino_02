/*
  ...
  Änderung zu xr_ampel2: Eine Zeitschleife statt delay() mit millis()
...
void loop() {
  ...
  //delay(2000);
  led_start_time=millis();   //aktuellen Zeitpunkt speichern
  while(millis()-led_start_time<200) {  //delay nur 200ms um den Unterschied zu sehen
   //mache nichts und warte 
  }
  // delay ende
